 ...
 * (the vault's 0x adapter routes it through AllowanceHolder internally).
 *
 * Note: The Rigoblock vault 0x adapter is not yet implemented — swaps
 * will revert on-chain. This module builds the infrastructure.
 *
