...
const {
  ...
  mockPreCheckNavImpact: vi.fn().mockResolvedValue({}),
  mockEstimateGas: vi.fn().mockResolvedValue("0x493e0"),
...
vi.mock("../src/llm/client.js", () => ({
  ...
  preCheckNavImpact: mockPreCheckNavImpact,
